...
(function(require) {
    'use strict';
    console.log(document.getElementById('main').getAttribute('data-baseurl'));
    require.config({
        baseUrl: './js',
        paths: {
            'etc': '../etc',
            ...
            'highcharts': 'bower/highcharts/4.0.4/highcharts',
            'highchartsMore': 'bower/highcharts/4.0.4/highcharts-more',
        },
        shim: {
            'jquery': {
                exports: '$'
